...
export function LocaleNotification(props: ILocaleNotificationProps) {
  ...
  return (
    ...
    >
      ...
      >
        <p>
          The current locale has changed to {locale}, click the button to reload
          the Page and applying the changes.
        </p>
        <p style={{ fontWeight: 'bold' }}>
          Notice: Reload the Page could lose the data, Please confirm you have
          saved before.
        </p>
      </div>
      <div
