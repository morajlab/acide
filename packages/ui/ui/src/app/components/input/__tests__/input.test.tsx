...
describe('Test Input Component', () => {
  ...
  test('Input style', () => {
    ...
    const wrapper = render(
      <Input data-testid={TEST_ID} style={{ background: INPUT_BGCOLOR }} />
    );
    const placeHolderContain = wrapper.getByTestId(TEST_ID).style.background;
  ...
  test('Input value', () => {
    ...
    const wrapper = render(<Input data-testid={TEST_ID} value={VALUE_INPUT} />);
      ...
      render() {
        ...
        return (
          <>
            ...
            <button data-testid={BUTTON_ID} type="button" onClick={this.up}>
              up
            </button>
          </>
        );
