...
describe('Test ActionBar Component', () => {
  ...
  test('Checkbox value attribute correctly', () => {
    ...
    const component = renderer.create(<Checkbox {...mockData} value={value} />);
    const componentInstance = component.root;
  ...
  test('Checkbox children render correctly', () => {
    ...
    const componentInstance = component.root;
    const nodeParagraph = (
      componentInstance.findByType('label')
  ...
  test('Checkbox classname attribute correctly', () => {
    ...
    const wrapper = render(
      <Checkbox data-testid="checkbox" {...mockData} className={className} />
    );
  ...
  test('Checkbox change event correctly', () => {
    ...
    render(
      <Checkbox value={testValue} id={TEST_FLAG} onChange={mockCallback} />
    );
