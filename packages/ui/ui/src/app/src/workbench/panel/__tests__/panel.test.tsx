...
describe('Test Panel Component', () => {
  ...
  test('Customize the Panel render content', () => {
    ...
    const { container, rerender, getAllByText } = render(<Panel {...panel} />);
    expect(container.querySelector('.mo-monaco-editor')).toBeInTheDocument();
  ...
  test('Sort the Panel ', () => {
    ...
    const tabs = container.querySelectorAll<HTMLDivElement>('.mo-tab__item');
