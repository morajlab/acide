      ...
      <Scrollable isShowShadow>
        <div>
          ...
          <div style={{ margin: '50px 20px' }}>
            ...
            <Button onClick={toggleNotification}>Toggle Notifications</Button>
          </div>
          <div style={{ margin: '50px 20px' }}>
            <h2>MenuBar:</h2>
            ...
            <Button onClick={addSettingsItem}>Append Settings Item</Button>
            <Button onClick={toggleMenuBarMode}>Toggle MenuBar mode</Button>
          </div>
          <div style={{ margin: '50px 20px' }}>
            <h2>Exploer:</h2>
